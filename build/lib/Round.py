...
class Round:
    ...
    def set_submission(self, submission, time_elapsed):
        ...
        print("submission", submission, "self.pick", self.pick)
        self.score_round()
    ...
    def score_round(self):
        print("score_round", self.pick, self.submission)
        score = score_attempt(self.pick, self.submission)
        self.score = score

    def get_score(self, format=False):
        if format:
            print(self.pick, self.submission, self.score, self.time_elapsed)
